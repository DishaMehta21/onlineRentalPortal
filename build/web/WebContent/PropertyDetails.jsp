            ...
            <div class="bg-white">
                <div class="row mb-5">
                    <div class="col-md-6">
                        ...
                        <h4><output class="price rounded" value="&nbsp;&nbsp; " style="color: black"><% if(rs.getString(24)!=null){ out.print("Average Rating: "+rs.getString(24));} else {out.print("Average Rating: 0");}%> </output></h4><br>
                    </div>
                    <div class="col-md-6">

<%-- 
    Document   : AboutUs
    Created on : 25 Aug, 2019, 3:18:00 PM
    ...
    <div align="left" style="width: 100%">
        <table>
            <tr>
                ...
                <td><label style="font-size: medium">Homestate is an internet portal dedicated to meet every aspect of the consumers needs in the real estate industry. It is a forum where buyers, sellers and brokers can exchange information, quickly, effectively and inexpensively.</label></td>
                <td style="width: 100px"></td>
            </tr>
            <tr>
                <td style="width: 100px"></td>
                <td><label style="font-size: medium">It features commercial and residential properties for sale rent and leases the fore properties, rates, locations, property news and also major events and happenings in the genre are the highlights of this portal.
                        The system should track the status of each user’s property, the feedback of the property and generate the leads of every registered user.</label></td>
                <td style="width: 100px"></td>
            </tr>
            <tr>
                <td style="width: 100px"></td>
                <td><label style="font-size: medium">The system should track the status of each user’s property, the feedback of the property and generate the leads of every registered user.</label></td>
                <td style="width: 100px"></td>
            </tr>
            <tr>
                <td style="width: 100px"></td>
                <td><label style="font-size: medium">Customer can see the current status of their property/properties.</label></td>
                <td style="width: 100px"></td>
            </tr>
            <tr>
                <td style="width: 100px"></td>
                <td><label style="font-size: medium">At Homestate, you can advertise a property, search for a property, browse through properties, build your own property Microsite, and visit other properties.</label></td>
                <td style="width: 100px"></td>
            </tr>
        </table>
    </div>

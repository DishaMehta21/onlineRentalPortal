<%-- 
    Document   : ContactUs
    Created on : 25 Aug, 2019, 3:26:17 PM
       ...
       <form>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0"><a href="#"><span class="text-black fl-bigmug-line-email64"></span> <span class="d-none d-md-inline-block ml-2"><span class="d-none d-md-inline-block ml-2">HomeState.info@gmail.com</span></span></a></p>
    ...
    <div class="container">
      ...
      <div class="row block-13">
        ...
        <div class="nonloop-block-13 owl-carousel">
          ...
          <div class="slide-item">
            <div class="team-member text-center">
                <img src="../Upload/mahi.JPG" alt="Image" class="img-fluid mb-4 w-50 rounded-circle mx-auto"/>
              <div class="text p-3">
                <h2 class="mb-2 font-weight-light text-black h4">Mahime Gajiwala</h2>
                <span class="d-block mb-3 text-white-opacity-05">&ldquo; Developer &rdquo;</span>
                <p class="mb-5"></p>

    ...
    <body>
       <%@page import="Email.Email" %> 
        ...
        Statement st=con.createStatement();
         ResultSet rs1=st.executeQuery("select tblsellorrentproperty.RegisterUserID, tblregisteruser.UserName , tblpropertylocation.Address, tblpropertylocation.City from tblsellorrentproperty INNER JOIN tblregisteruser ON tblsellorrentproperty.RegisterUserID=tblregisteruser.RegisterUserID INNER JOIN tblpropertylocation ON  tblpropertylocation.PropertyLocationID=tblsellorrentproperty.PropertyLocationID where tblsellorrentproperty.SellOrRentPropertyID='"+ session.getAttribute("PropertyId")+"';");
         while(rs1.next()){

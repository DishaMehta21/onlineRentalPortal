                    ...
                    <div>
                        <div align="left">
                            <div style="align-content: flex-start">
                                <h1 class="mb-2">
                                    <label style="color:green"><%out.print(rs.getString(10));%> BHK | <%out.print(rs.getString(13));%></label>
                                </h1>
                                    <h3 class="mb-5"><label style="color:black">Rs.</label><label style="color:blue"> <%out.print(rs.getString(5));%></label> | <label style="color:black">Bedrooms: </label> <label style="color:blue"><%out.print(rs.getString(10));%></label> | <label style="color:black">Bathrooms: </label> <label style="color:blue"><% if(rs.getString(11)!=null){ out.print(rs.getString(11)); }else out.print(0);%></label></h3>
                                <h3 class="mb-2">
